...
def main(args):
    ...
    pqr_file = pdb.split(".")[0] + '_out/pockets/pocket' + str(k) + '_vert.pqr'
    ...
    try:
        ...
        #exit()
    ##
    # HAVE to check every pocket which one contains the ligand???
